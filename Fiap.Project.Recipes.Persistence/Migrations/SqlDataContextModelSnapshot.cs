...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fiap.Project.Recipes.Domain.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fiap.Project.Recipes.Domain.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fiap.Project.Recipes.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fiap.Project.Recipes.Domain.Models.Recipe", b =>
                {
                    b.HasOne("Fiap.Project.Recipes.Domain.Models.Category", "CategoryRecipe")
                        .WithMany()
